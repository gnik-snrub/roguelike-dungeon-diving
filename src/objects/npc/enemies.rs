...
impl Object {
    ...
    fn monster_level_up(mut fighter: Fighter, mut level_up: u32) {
        while level_up > 0 {
            let hp_addition = fighter.max_hp / 5;
    ...
    pub fn fire_elemental(x: i32, y: i32, level_up: u32) -> Character {
        ...
        Object::monster_level_up(fighter, level_up);
        fire_elemental.object.fighter = Some(fighter);
        fire_elemental
    }

    pub fn crystal_lizard(x: i32, y: i32, level_up: u32) -> Character {
